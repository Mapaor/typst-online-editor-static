// This is an example for showing how "templates" are created.

// With local templates you can standardize your documents (for example with the layout and branding of your company or organization).

// In this example we are recreating the following template:
// #import "@preview/academicv:1.0.0": *

// But locally i.e. having some .typ files in our editor  defining the template and importing them.

// The main file for the template is the following file:
#import "cv.typ": *

// And in this template the content (of the CV) is defined in a separate YAML data file:
#let cv-data = yaml("example-cv.yml")
